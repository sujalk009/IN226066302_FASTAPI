...
# ══════════════════════════════════════════════════════════════
# Q5 — GET /products/audit  ← MUST be above /products/{product_id}
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
# BONUS — PUT /products/discount  ← MUST be above /products/{product_id}
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
# Q2 — PUT /products/{product_id}  (Update price / in_stock)
# ══════════════════════════════════════════════════════════════
